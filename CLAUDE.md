...
### Текущее состояние — M1, EPIC-007 закрыт

Спецификация завершена (фаза 0). EPIC-001…EPIC-007 — в статусе `review`. Следующий по
[roadmap](docs/product/roadmap.md) — EPIC-008 (двуязычность). Актуальный борд —
...
проставлены ключи, но переводить их нечем (EPIC-008); мастерской компонентов с псевдолокалью (перенесена в STORY-008-06);
