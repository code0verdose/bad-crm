...
### Текущее состояние — M1, EPIC-006 закрыт

Спецификация завершена (фаза 0). EPIC-001…EPIC-006 — в статусе `review`, все девять историй
EPIC-006 переведены на зелёном commit-гейте. Следующий по
[roadmap](docs/product/roadmap.md) — EPIC-007 (дизайн-система). Актуальный борд —
