...
сотрудника, на справочнике и на матрице ролей. Восьмой («ловушка фокуса в модалке») закрыт наполовину: модалок в
продукте теперь две, тест ловушки фокуса есть у диалога офбординга (EPIC-012) и отсутствует у
`role-matrix-preview-modal`. Пункт остаётся открытым до второго теста.
