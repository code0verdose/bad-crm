...
### Текущее состояние — M1, EPIC-008 закрыт

Спецификация завершена (фаза 0). EPIC-001…EPIC-008 — в статусе `review`. Следующий по
[roadmap](docs/product/roadmap.md) — EPIC-009 (observability). Актуальный борд —
...
(EPIC-011); переключателя организации и юнита `units/organization`; привязки `errors[].path` к полям
