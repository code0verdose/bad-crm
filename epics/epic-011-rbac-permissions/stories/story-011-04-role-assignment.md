...
Осталось в этой истории: use-cases назначения и отзыва, счётчик владельцев внутри транзакции,
маршруты `POST/DELETE /users/{userId}/roles`, инкремент `permissions_version` носителям и
джоб-чистильщик истёкших грантов.
