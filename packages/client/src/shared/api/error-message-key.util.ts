...
export const ERROR_MESSAGE_KEY: Readonly<Record<SharedErrors.ErrorCode, string>> = {
  ...
  invitation_not_valid: 'errors.code.invitation_not_valid',
  ...
  period_locked: 'errors.code.period_locked',
  ...
  invalid_totp_code: 'errors.code.invalid_totp_code',
  totp_code_replayed: 'errors.code.totp_code_replayed',
  mfa_already_enabled: 'errors.code.mfa_already_enabled',
  reauthentication_required: 'errors.code.reauthentication_required',
  recovery_code_invalid: 'errors.code.recovery_code_invalid',
